...
### 6 Esperança e Variância condicional

Uma extensão do conceito de distribuição condicional, é o de esperança condicional. Assumindo que $Y_1$ e $Y_2$ são variáveis aleatórias assumindo valores em $\mathbb{R}$. Então, a esperança condicional de $Y_1$ dado  $Y_2=x$ é dada por: 


$$E[Y_1/Y_2=x ]= \int_{-\infty }^{\infty} y_1 f_{Y_1|Y_2=x}(y_1,x)  \partial y_1$$
Uma importante propriedade da esperança condicional é dada a seguir.


$$E[E(Y_1/Y_2=x)]=\int_{-\infty }^{\infty} E(Y_1/Y_2=x)f_Y(y)=E[Y_1].$$
A demostranção dessa propriedade pode ser vista em @ross2009probabilidade.
