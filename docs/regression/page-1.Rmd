...
Como já foi citado o modelo de regressão linear irá descrever uma relação de uma varável y com uma variável x que será expressa por uma reta. O erro é representado pela letra grega $\epsilon$, pode-se fazer uma análise residual(verificar independência das variáveis) com um intuito de encontrar betas que minimizem os erros. 
